                            ...
                            <div class="row">
                                <div class="col-xl-4 my-auto">
                                    <figure>
                                        <img src="<?php echo esc_url(
                                            get_template_directory_uri()
                                        ); ?>/assets/images/thumb-producto.png" alt="" class="img-fluid">
                                    </figure>
                                </div>
                                <div class="col-xl-8 my-auto">
                                    <div class="row">
                                        <div class="col-xl-8 mb-4 mb-xl-0">
                                            <h1>Salchicha Viena</h1>
                                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Culpa velit consequatur, explicabo sit quasi, ullam atque corrupti iure id ut eos quis inventore adipisci hic ducimus, nobis maxime debitis aut.</p>
                                            <h2>Presentación</h2>
